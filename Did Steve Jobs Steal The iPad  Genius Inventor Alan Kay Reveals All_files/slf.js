...
var ANPIRPSL=1;
var ANPIRSSL=0;
var ANPIS="unescape().toLowerCase()";
var ANPUF=1;
var ANSID=13649;
var ANTCC;
...
var ANRDF=1;
var ANSCC="unescape(isSocialNetworkShared()+safeVar('hbxmlc')+document.location.href+getElementById('breadcrumbs').replace(/&[a-zA-Z]+;/g, '').replace(/['$?]+/g,'')+catmanduLoggerWithStr(getElementById('breadcrumbs'))+catmandu_integration_mcc(document.referrer, document.location.href, '/search.php.*s=([^&]+)')).toLowerCase()";
var ANTPUD;
var ANVDT=0;
var CCLOOKUP22='AHCMpicturestory/computing/notebooks_and_laptops|APEL/digital_entertainment/digital_still_cameras|BWIRcpu-amp-components/network-interface-cards|AHCMpicturestory/computing/mice_and_keyboards|AHCM/opinions-and-experiences/computer-shops|BAECgeneral/cell-phones-wap-mobile-internet|AHCMpicturestory/components/graphics_cards|YHCMmotherboards|AADPcharts/processors/mobile_cpu_charts|AHCM/cpu-amp-components/power-supplies|UHCMsound-cards|CADQomputer-peripherals/printers|BADAgames-general/console-gaming|BADZaudio/mp-players-and-music|BHCMcomponents/graphics_cards|AHCMslideshows/the_apple_mac|AHCM/components/motherboards|BHCMmotherboards-amp-memory|BHCMcpu-amp-components/cpus|ATBHtopic/business_servers|AADQ/peripherals/printers/|BADPlaptops-amp-notebooks|AAEBhome-theater|AAED/home-cinema-equipment|BHCMcharts/graphics-cards|BAEAmobility/smartphones|BWIRcomputing/networking|AADRpicturestory/software|AHCM/computer-peripherals|AHCMcharts/graphics_cards|AHCMslideshows/apple_mac|AWIR/wireless-networking|BHCMmotherboards-memory|BWIRgeneral-networking|BHCMcpu-amp-components|CHCMharts/hard-drives|BAEAmobility-networks|BHCMhomebuilt-systems|BADKdeals/classifieds|AHCMcharts/hard_drives|AHCM/mobile-computing|AHCMcharts/processors|AAEA/mobility-brands|BHCMpower_supplies|BHCMgraphics_cards|BHCMcomponents/cpu|BPELdigital-camera|BHCMcpu-components|CADOharts/desktop|BADAgames-general|BADAconsolegaming|BADOworkstations|BPELdigitalphoto|BHCMmotherboards|BHCMoverclocking|BAEDhome-theatre|BADRapplications|BPELdigitalhome|BHCMperipherals|BHCMcomponents|ADUXtomsguidegadgetssmartphonesarticlesmartphones|[DUXsnewssmartphones|EADPhardwareallreviewssolutionsnotebook|[ADRtionssoftware|A#DVTandroid.*tablet|A#DVTblackberry.*playbook|AADRvirus_malware_security|APELcamcorder|AADPlaptop|AADPnetbook|BADPotebooks|AADR/software/|BADOdesktops|BTBHservers/|BHCMhardware|BHCMstorage|BADRwindows|BHCMsystems|BADRdrivers|BADRnetware|BADRopenvms|BHCMmemory|BADRoffice|BADAgaming|BAEAphone|AATQblu-ray|DATQray|AADR/linux|BADKdeals|APELforums/audio|GFOR|AADR/dbase|BADRucg/|CADRnix|BAEApda|BHCMcpu|BHCMmac|BADRos2|AESYipad|CFDYhone|CADZod|AADAxbox|APELgps-nav|AHCMcomputing.net|AAGLthetorquereport.com|BADNomsguide.com|EADShardware.com|AECMsocialnetwork:share|TECI:facebook|UFILgoogleplus|UECKlifestream|UEUMtwitter|UEWTfacebook:like|[FIQok:recommend|UFIWstumbleupon';
var ANAXLSL='';
var ANCB1=0;
var ANCB3=0;
var ANRD='';
...
{
return document.getElementById(Id).innerHTML.replace(/(<([^>]+)>)/ig,"").replace(/[_\s+-\/:]/g,"").toLowerCase();
}
else
{
return"";
...
return kw;
}function catmanduLoggerWithStr(str){
window.ANGPU=function(){
var ustr="";
var c=-1;
var kw="";
try{c=CMMISS;kw=CMKW}catch(e){}
ustr+=escape(document.location.href+"&ifu="+escape(document.referrer)+"&cmmiss="+escape(c)+"&cmkw="+escape(kw)+"&lstr="+escape(str));
return ustr;
}
}function isSocialNetworkShared(){
var smPrefix="socialnetwork:share";
var smSites={"twitter":/twitter.com/i,
"facebook":/facebook.com.l.php/i,
